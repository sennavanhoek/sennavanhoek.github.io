---
layout: post
title:  "2 ways to get serial output from a STM32F4 Discovery board without a UART dongle.
"
categories: SWD UART 
permalink: "/usart-swd/"
---

In contrast to more modern boards, there is no internal serial connection between the target chip and the on-board debugger. A common solution is to use a USB serial interface converter, but what if you don’t want the additional clutter or your cheap jumper cables keep disconnecting?
